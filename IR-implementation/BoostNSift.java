...
public class BoostNSift {
 ...
 static HashMap<Integer, Float> grandResults = new HashMap<Integer, Float>();
    public static void main(String[] args) throws IOException, ParseException {
       //Following statement might throw error for the first time when index directory does not exist
        FileUtils.cleanDirectory(new File("D\\index\\"));
 ...
 //--------------------------------------------------------------------------------------------//       
        ...
        File file = new File("D:\\Implementations\\Experiments\\SWT\\Corpus_SWT.csv");
...
//--------------------------------------------------------------------------------------------//       
     ...
     // Read title, descriptions and comments in temporary objects
        ...
        Qfile = new File("D:\\Implementations\\Experiments\\SWT\\SWTTitles.csv");
        ...
        Qfile = new File("D:\\Implementations\\Experiments\\SWT\\SWTDesc.csv");
        try (FileReader fileReader = new FileReader(Qfile)) {
            BufferedReader bufferedReader = new BufferedReader(fileReader);
            String qry;
        ...
        Qfile = new File("D:\\Implementations\\Experiments\\SWT\\SWTComm.csv");
        try (FileReader fileReader = new FileReader(Qfile)) {
            BufferedReader bufferedReader = new BufferedReader(fileReader);
            String qry;
        ...
        String newFileName = "D:\\Results\\CrudResults\\Lucene_SWT.csv";
