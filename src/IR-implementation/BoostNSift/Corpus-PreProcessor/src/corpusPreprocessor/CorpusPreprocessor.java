...
public class CorpusPreprocessor {
  ...
  public static String FILE_NAME_LIST_OF_STOP_WORDS = "/app/resources/stopwords.txt";
  ...
  public void preprocessCorpus() throws Exception {
    ...
    while ((buf = brOriginalCorpus.readLine()) != null) {
      ...
      FileWriter writer = new FileWriter(Path + i + ".txt", true);
      FileWriter writer1 = new FileWriter(Path1 + t + i + ".txt", true);
