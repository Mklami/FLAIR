...
public class InputOutputCorpusFileLevelGranularity extends InputOutput {
  ...
  public InputOutputCorpusFileLevelGranularity(String inputFileNameWithListOfInputFileNames, String outputFolderName, String outputFileNameWithoutExtension) throws IOException {
    ...
    if (!directory.exists()) {
      if (!directory.mkdirs()) {
        throw new IOException("InputOutputCorpusFileLevelGranularity: Could not create directory: " + outputFolderName);
      }
    }
  }
